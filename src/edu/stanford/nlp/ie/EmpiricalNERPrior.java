...
public class EmpiricalNERPrior extends EntityCachingAbstractSequencePrior {
  ...
  public EmpiricalNERPrior(String backgroundSymbol, Index classIndex, List<CoreLabel> doc) {
